...
export default function Page() {
  return (
    <>
      ...
      <div className=" flex items-center bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg max-w-2xl  mb-4">

        <div className="relative sm:rounded-lg"><span><h2 className="text-gray-900 dark:text-white text-3xl font-extrabold m-3">Safety</h2></span>
      ...
      <div className="grid md:grid-cols-2 gap-8 ">
        <div className="bg-yellow-200 dark:bg-gray-800 dark:border-gray-700 rounded-lg  md:p-12 mb-1">
